            ...
            <div className="row align-items-center">
              <div className="col-lg-8 col-md-12">
                <div className="get-instant-courses-content">
                  ...
                  <p>
                    subtubes Self Development Course can assist you in bringing
                    the significant changes in personal understanding and
                    reshaping the confidence to achieve the best from your
                    career! We trust that learning should be enjoyable, and only
                  ...
                  {user ? (
                    <Link href="/learning/my-courses/">
                      <a className="default-btn">
                        <i className="flaticon-user"></i> My Courses{" "}
                        <span></span>
                      </a>
                    </Link>
                  ) : (
